...
| `run`     | Optional `BRUNO_COLLECTION`, `BRUNO_ENV`, `EXTRA_ARGS`, `CLI_ARGS` | Run all requests in the Bruno collection.                |
| `ci`      | Optional `BRUNO_COLLECTION`, `BRUNO_ENV`, `EXTRA_ARGS`, `CLI_ARGS` | Run collection and stop on the first failure (`--bail`). |
